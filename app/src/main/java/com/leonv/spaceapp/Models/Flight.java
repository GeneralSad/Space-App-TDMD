...
public class Flight implements Serializable {
    ...
    private boolean areReusedFairings;
    ...
    public Flight(boolean areReusedFairings, String webcastLink, String articleLink, String wikipediaLink, String staticFireDateUtc, boolean isTBD, boolean isNET, String rocketId, String launchDetails, ArrayList<String> payloadIds, String launchpadId, int flightNumber, String name, String launchDateUtc, String datePrecision, ArrayList<RocketFlightCore> cores, String flightId) {
        this.areReusedFairings = areReusedFairings;
    ...
    public boolean areReusedFairings() {
        return areReusedFairings;
    }
